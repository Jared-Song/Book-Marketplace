...
public class BrowsingController { // browsing all available books
    ...
    public Iterable<Book> getByTitle(@PathVariable String title) {
        LOGGER.info("Finding all books containing the title '" + title + "'");
    ...
    public Iterable<Book> getByAuthorFirstName(@PathVariable String authorName) {
        LOGGER.info("Finding all books written by author's with the name '" + authorName + "'");
    ...
    public Iterable<Book> getBySeller(@PathVariable Long sellerId) {
        LOGGER.info("Finding all books sold by users with the ID " + sellerId);
    ...
    public Iterable<Book> getByCategory(@PathVariable String category) {
        LOGGER.info("Finding all books in the category '" + category + "'");
    ...
    public Iterable<Book> getByISBN(@PathVariable int isbn) {
        LOGGER.info("Finding all books containing the following ISBN '" + isbn + "'");
    ...
    public Iterable<Book> getNewBooks() {
        LOGGER.info("Finding all books that have the quality NEW");
    ...
    public Iterable<Book> getUsedBooks() {
        LOGGER.info("Finding all books that have the quality USED");
    ...
    public Iterable<Book> sortByPriceHighToLow() {
        LOGGER.info("Finding all books sorted from highest to lowest price");
    ...
    public Iterable<Book> sortByPriceLowToHigh() {
        LOGGER.info("Finding all books sorted from lowest to highest price");
    ...
    public Iterable<Book> sortByAlphabet() {
        LOGGER.info("Finding all books sorted by alphabetical title order");
    ...
    public Iterable<Book> newReleases(@PathVariable int size) {
        LOGGER.info("Finding " + size + " books sorted by most recently added");
    ...
    public Iterable<Book> bestSellers(@PathVariable int size) {
        LOGGER.info("Finding " + size + " books sorted by highest rating");
    ...
    public Iterable<Book> random(@PathVariable int size) {
        LOGGER.info("Finding " + size + " random books");
